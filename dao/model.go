...
type ServiceTreeNode struct {
	...
	// 和该服务有关系的节点
	LinkNodeList []ServiceTreeNode `json:"linkNodeList,omitempty"`
}
...
type ServiceTree struct {
	...
	// 关系树的根节点
	RootNode ServiceTreeNode `json:"treeNode,omitempty"`
}

//
// 多个服务的调用关系树
//
type ServiceListTree struct {
	// 关系树中的所有服务
	ServiceList []Service `json:"serviceList,omitempty"`
	// 关系树的根节点
	RootNodeList []ServiceTreeNode `json:"treeNodeList,omitempty"`
}
